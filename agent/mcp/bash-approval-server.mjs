...
//
// `commandPolicyCache` bleibt bewusst auf Modulebene: die Richtlinien gelten
// container-weit, der Cache ist reine Beschleunigung. Geteilt zu werden ist
// hier richtig und spart Abrufe (#638, Fund 2).
...
await startServer("bash-approval", buildServer);

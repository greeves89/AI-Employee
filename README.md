...
[![Version](https://img.shields.io/badge/version-1.55.11-green.svg)](VERSION)
...
> **Neu in v1.55:** Native APNs-Pushes, kanalbewusste Agent-Kommunikation (iOS, Telegram, Webapp), voll integrierte Approval-Anfragen, Dateien/PDFs/Audio direkt im iOS- und Webapp-Chat, Live-Voice-Session mit STT/TTS und deutscher STT-Standardsprache, neues AI-Employee-App-Icon, robustere Agent-Chat-Verarbeitung mit Turn-Timeouts, eine einheitliche Agent-Auth-Erkennung und sauberes Inter-Agent-Messaging mit abrufbarem Nachrichten- und Conversation-Verlauf.

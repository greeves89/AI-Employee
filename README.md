...
[![Version](https://img.shields.io/badge/version-1.55.2-green.svg)](VERSION)
...
> **Neu in v1.55:** Native APNs-Pushes, kanalbewusste Agent-Kommunikation (iOS, Telegram, Webapp), voll integrierte Approval-Anfragen, Dateien/PDFs direkt im Chat, Live-Voice-Session mit STT/TTS und robustere Agent-Chat-Verarbeitung mit Turn-Timeouts.

...
_PLATFORM_SECTION = (
    ...
    "**Shared Knowledge Base** (company-wide, Obsidian-style):\n"
    "- `knowledge_write` - Create/update a knowledge entry (all agents can read it!)\n"
    "- `knowledge_search` - Search the shared knowledge base by keyword or tag\n"
    ...
    "- **Knowledge Base** (`knowledge_write`) = SHARED company knowledge. All agents and the user can see it.\n"
    "- Use Knowledge Base for: company info, brand guidelines, project docs, team decisions, processes\n"
    "- Use Memory for: your personal preferences, task-specific notes, corrections you received\n\n"

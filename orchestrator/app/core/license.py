...
# Public key of the AI-Employee License Server (future-app-hub/license-server,
# lizenzen.future-app.de). The corresponding private key is held ONLY there
# (Pi-local .env, generated by scripts/generate-secrets.sh, never leaves the box).
# Licenses that do not verify against this key are rejected.
LICENSE_SERVER_PUBLIC_KEY = """-----BEGIN PUBLIC KEY-----
MCowBQYDK2VwAyEA9slJUx2+4CLylqbdNJbvuL8nyvtacZ3cU5eC8n3Ct3c=
-----END PUBLIC KEY-----
"""
